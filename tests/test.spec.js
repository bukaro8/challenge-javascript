...
describe('Practica del Checkpoint M1', function(){
    ...
    describe('EJERCICIO 1: exponencial:', function() {
        ...
        it.only('La funcion hija debe de elevar al cuadrado, si 2 le es pasado como parametro a la funcion padre', function() {
        ...
        it.only('La funcion hija debe de elevar al cubo, si 3 le es pasado como parametro a la funcion padre', function() {
            expect(typeof e3).to.be.equal('function');
            expect(e3(2)).to.be.equal(8);
            expect(e3(3)).to.be.equal(27);
            expect(e3(4)).to.be.equal(64);
        });
        it.only('La funcion hija debe de elevar a 4, si 4 le es pasado como parametro a la funcion padre', function() {
    ...
    describe('EJERCICIO 2: direcciones:', function(){
        ...
        it.only("Si no se le pasa un laberinto debe retornar ''", function() {
            expect(direcciones()).to.be.equal('');
        });
        it.only("Si se le pasa un laberinto sin destino debe retornar ''", function() {
            expect(direcciones({N:'pared', S:'pared', E:'pared', O:'pared'})).to.be.equal('');
        });
        it.only("Debe encontrar el destino dentro del laberinto y retornar los movimientos", function() {
    ...
    describe('EJERCICIO 3: deepEqualArrays', function(){
        it.only('Debe hacer comparaciones superficiales', function(){
